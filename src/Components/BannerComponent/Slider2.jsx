...
export default function Slider2() {
  return (
    <section className="font-poppins text-white">
      <div className="bg-[url('https://i.ibb.co.com/zGY0KLQ/slider2.jpg')] bg-blue-600 bg-blend-multiply bg-no-repeat bg-cover lg:bg-center rounded-lg min-h-[600px]">
        <div className="flex flex-col items-center justify-center w-3/4 mx-auto py-8 space-y-10">
          ...
          <div className="text-center space-y-5">
            <h1 className="text-xl md:text-2xl lg:text-4xl font-bold">
              Building Dreams Together, One Step Forward
            </h1>
            <p className="text-sm md:text-base text-gray-200 text-center w-full lg:w-3/5 mx-auto">
              Join a community to support innovative ideas, heartfelt causes,
              and projects. Together, we can turn hope into action and create
              meaningful, lasting impact in lives around the world.
            </p>
          </div>
