...
export default function Slider3() {
  return (
    <section className="font-poppins text-white">
      <div className="bg-[url('https://i.ibb.co.com/RYrhw59/Blog-page-images-3-141-768x402.jpg')] bg-blue-700 bg-blend-multiply bg-no-repeat bg-cover bg-center rounded-lg min-h-[600px]">
